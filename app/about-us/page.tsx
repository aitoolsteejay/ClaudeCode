...
export const metadata: Metadata = {
  ...
  keywords: [
    "tejas jhaveri",
    "tejas jhaveri myntmore",
    "b2b growth expert",
    "founder of myntmore",
    "tedx speaker mumbai",
    "b2b lead generation expert",
    "angel investor mumbai",
    "b2b outbound agency founder",
    "myntmore about us",
    "b2b growth strategist",
    "outbound marketing expert india",
    "linkedin growth expert",
    "b2b sales pipeline expert",
    "growth educator iit iim",
    "mumbai b2b agency founder",
  ],
  openGraph: {
      ...
      <section className="pt-32 pb-16 px-4" style={{ backgroundColor: "#F8F6F2" }}>
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg sm:text-xl leading-relaxed max-w-2xl hero-fade-d2" style={{ color: "#52525B" }}>
            Tejas Jhaveri is a TEDx speaker, angel investor, and B2B growth expert based in Mumbai, with over 10 years of lead generation experience. He founded Myntmore in 2019, and the team has since booked 12K+ meetings and generated $120M+ in pipeline for 300+ B2B companies.
          </p>
        </div>
      </section>
