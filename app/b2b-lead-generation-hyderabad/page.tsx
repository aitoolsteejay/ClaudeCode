...
export const metadata: Metadata = {
  ...
  description: "AI-powered B2B lead generation for Hyderabad's IT, pharma, and biotech firms: cold email, LinkedIn & ABM. Book a free GTM audit.",
...
export default function B2BLeadGenerationHyderabadPage() {
  return (
    <InnerLayout>
      ...
      <JsonLd data={buildLocalBusinessSchema("https://www.myntmore.com/b2b-lead-generation-hyderabad")} />
