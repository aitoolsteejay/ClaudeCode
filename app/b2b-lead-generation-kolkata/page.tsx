...
export const metadata: Metadata = {
  ...
  keywords: ["b2b lead generation kolkata", "outbound agency kolkata", "linkedin outreach kolkata", "cold email agency west bengal", "account based marketing kolkata"],
  openGraph: {
    title: "B2B Lead Generation Agency in Kolkata | Myntmore",
...
const WHY_CITY = [
  { title: "Decades of trading relationships, no way to grow past them", desc: "Kolkata's legacy trading houses, and its long-standing strength in jute, steel, and engineering, have grown on networks built over generations. That's a strong foundation, but it caps growth once every existing relationship has been tapped." },
  { title: "An IT sector competing against better-funded rivals", desc: "Kolkata's growing IT and ITES companies are up against far larger tech hubs like Bengaluru and Pune for the same buyers. Winning that fight needs a sharper, more systematic outbound motion, not more cold calls." },
  { title: "Financial services with deep history, thin digital pipeline", desc: "The city's long-established financial services base has real credibility, but much of its new-business generation still depends on personal networks rather than a repeatable outbound system." },
];
...
const DIFFERENTIATORS = [
  "AI-powered outbound systems instead of manual, referral-based prospecting",
...
const FAQ = [
  { q: "Do we need to be based in Kolkata to work with you?", a: "No. The entire engagement runs remotely, so it doesn't matter where in West Bengal, or beyond, your team is based." },
  { q: "Do you only work with Kolkata companies?", a: "No. We have clients in Kolkata, but we run outbound systems for B2B companies across India and internationally." },
  ...
  { q: "Which Kolkata industries do you have the most experience with?", a: "Trading and manufacturing houses, steel and engineering firms, and growing IT/ITES companies are where we've run the most campaigns, but our system adapts to any B2B ICP." },
  { q: "What channels do you actually use to generate leads?", a: "Primarily cold email and LinkedIn outreach aimed at trading, manufacturing, and financial-services buyers, layered with account-based marketing for named target accounts, and AI-assisted list building and personalisation underneath all three. We pick the mix based on where your buyers actually spend their attention." },
  { q: "How is this different from hiring an in-house SDR?", a: "Hiring an in-house SDR in Kolkata means months of recruiting and ramp-up before they're fully productive, and even then, one person can only run so many sequences at once. A managed outbound system gets multiple channels running from week one, at a fraction of the fully loaded cost of a hire, and scales without you managing headcount." },
...
export default function B2BLeadGenerationKolkataPage() {
  return (
    <InnerLayout>
      <section className="pt-32 pb-16 px-4" style={{ backgroundColor: "#F8F6F2" }}>
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black mb-6 leading-tight" style={{ color: "#0a0a0a" }}>
            B2B Lead Generation Agency in Kolkata
          </h1>
          <p className="text-lg sm:text-xl max-w-2xl mb-8" style={{ color: "#52525B" }}>
            Kolkata carries decades of strength in trading, steel, and engineering, alongside a fast-growing IT sector. We build the AI-powered cold email, LinkedIn, and ABM systems that turn that legacy into new pipeline.
          </p>
      ...
      <section className="py-16 px-4 border-t" style={{ borderColor: "#E8E2D9" }}>
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-black mb-10" style={{ color: "#0a0a0a" }}>Why Kolkata businesses need this</h2>
      ...
      <section className="py-16 px-4 border-t" style={{ borderColor: "#E8E2D9" }}>
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-black mb-10" style={{ color: "#0a0a0a" }}>Why Myntmore over a typical Kolkata agency</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      ...
      <LeadCaptureForm title="Get a free GTM audit for your Kolkata business" subtitle="We'll audit your current outreach, map your ICP, and tell you exactly what's holding your pipeline back. No pitch, no pressure." />
    </InnerLayout>
  );
}
