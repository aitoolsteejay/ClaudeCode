...
export const metadata: Metadata = {
  ...
  description: "AI-powered B2B lead generation for Mumbai's BFSI, media, and corporate businesses: cold email, LinkedIn & ABM. Book a free GTM audit.",
...
export default function B2BLeadGenerationMumbaiPage() {
  return (
    <InnerLayout>
      ...
      <JsonLd data={buildLocalBusinessSchema("https://www.myntmore.com/b2b-lead-generation-mumbai")} />
