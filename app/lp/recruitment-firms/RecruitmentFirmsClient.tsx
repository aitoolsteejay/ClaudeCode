...
// /marketing-automation, and the services index), not staffing-specific results we
...
const FAQ_ITEMS = [
  ...
  { q: "Does this integrate with our ATS or CRM?", a: "We don't build or manage ATS or CRM integrations, whether that's Bullhorn, Zoho Recruit, or anything else, that stays part of your own process. Every qualified meeting and reply is handed off to your team directly, so it's easy to log wherever you already track pipeline." },
    ...
    <section className="py-20 px-4 border-t" style={{ borderColor: "#E8E2D9", backgroundColor: "#F8F6F2" }}>
      <div className="max-w-5xl mx-auto">
        <div ref={titleFade} className="mb-12">
          ...
          <h2 className="text-4xl sm:text-5xl font-black mt-3" style={{ color: "#0a0a0a" }}>Our track record in B2B outbound, the same system we&apos;re applying for staffing firms</h2>
        </div>
        ...
        <div className="rounded-2xl border p-8" style={{ backgroundColor: "#F8F6F2", borderColor: "#E8E2D9" }}>
          <form className="space-y-4"
            ...
            <div>
              ...
              <input id="Email" name="Email" type="email" required maxLength={255} placeholder="ananya@sharmastaffing.com" className="w-full px-4 py-3 rounded-xl text-sm outline-none border" style={{ backgroundColor: "#ffffff", borderColor: "#E8E2D9", color: "#0a0a0a" }} />
            </div>
