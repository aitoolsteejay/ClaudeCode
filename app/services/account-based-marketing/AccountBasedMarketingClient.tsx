    ...
    <InnerLayout>
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden" style={{ backgroundColor: "#F8F6F2" }}>
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          <Breadcrumbs items={[{ label: "Services", href: "/services" }, { label: "Account-Based Marketing", href: "/services/account-based-marketing" }]} />
      ...
      <section className="py-20 px-4 border-t" style={{ borderColor: "#E8E2D9", backgroundColor: "#ffffff" }}>
        <div className="max-w-2xl mx-auto text-center">
          <p className="text-lg leading-relaxed mb-6" style={{ color: "#3D3D3D" }}>
            Built by the same team running the account-based programs behind{" "}
