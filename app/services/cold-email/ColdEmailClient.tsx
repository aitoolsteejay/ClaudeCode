...
const NOT_FOR = [
  "Your buyers respond best to warm, relationship-led intros, not a written-first approach.",
  "You want to skip domain warm-up entirely and start sending at full volume tomorrow.",
    ...
    <InnerLayout>
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden" style={{ backgroundColor: "#F8F6F2" }}>
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          <Breadcrumbs items={[{ label: "Services", href: "/services" }, { label: "Cold Email", href: "/services/cold-email" }]} />
