...
const NOT_FOR = [
  "Your buyers barely check LinkedIn and are far more active on email.",
  "You want to blast the same message to thousands of profiles with no personalisation.",
  "You need volume beyond what LinkedIn's own connection and messaging limits allow.",
];
    ...
    <InnerLayout>
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden" style={{ backgroundColor: "#F8F6F2" }}>
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          <Breadcrumbs items={[{ label: "Services", href: "/services" }, { label: "LinkedIn Outreach", href: "/services/linkedin-outreach" }]} />
      ...
      <section className="py-20 px-4 border-t" style={{ borderColor: "#E8E2D9", backgroundColor: "#ffffff" }}>
        <div className="max-w-2xl mx-auto text-center">
          <p className="text-lg leading-relaxed mb-6" style={{ color: "#3D3D3D" }}>
            Built by the same team running the LinkedIn outreach behind{" "}
