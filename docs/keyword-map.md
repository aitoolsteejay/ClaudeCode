...
**Rule enforced:** no two pages across these 27 share the same primary keyword (the first entry in each page's `keywords` array). Confirmed clean as of this audit — see "Method" for how to re-verify.
